...
class ONNX_Generator(object):
    ...
    def onnx(self):
        ...
        '''
        dummy_input = torch.randn(4, 3, 513, 513, device="cuda")
        torch.onnx.export(self.model, dummy_input, "/home/bmw/sarala/pytorch-deeplab-xception/onnx/4x3x513x513/onnx1.6/deeplabv3_exception.onnx", verbose=True, input_names=input_names, output_names=output_names, opset_version=11,export_params=True)
        '''
        dummy_input = torch.randn(1, 3, 513, 513, device="cuda")
        torch.onnx.export(self.model, dummy_input, "/home/bmw/sarala/pytorch-deeplab-xception/onnx/1x3x513x513/onnx1.6/deeplabv3_exception.onnx", verbose=True, input_names=input_names, output_names=output_names, opset_version=11,export_params=True)
